    ...
    <div class="exit-intent-backdrop" role="dialog">
      <div class="exit-intent" ref="exit-intent">
        ...
        <header class="exit-intent-header">
          <h2>
            Por que já está indo embora?
          </h2>
        </header>

        <section class="row exit-intent-body">
          <img class="col" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTBhmG0fkpTaaVFzro_IcCSYczBUhIJe_4knQ&usqp=CAU" alt="Vira lata caramelo">
          <p class="col">
            Não queremos que você vá embora! Preparamos um conteúdo bem legal para você utilizar...<br />
            <strong>Tudo completamente gratuíto.</strong><br />
            Queremos apenas lhe auxiliar a deslanchar.
          </p>
        </section>

        <footer class="exit-intent-footer">
          <button type="button" class="ml-auto btn btn-success" @click="closePopUp" aria-label="Continuar na página">
            Continuar na página
          </button>
        </footer>
